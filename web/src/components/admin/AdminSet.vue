...
<v-container v-else fluid class="problemset-container">
    ...
    <div class="filter-container">
        <v-card variant="text" class="pb-2 pl-2 pr-2" title="筛选题库" subtitle="通过名称搜索、选择科目或选择时间范围进行筛选" prepend-icon="mdi-filter">
            <v-row no-gutters>
                <v-col cols="12" sm="3">
                    <v-row align="center" justify="start">
                        <v-col cols="12" sm="12" md="12" class="pa-2">
                            <v-text-field v-model="filterName" label="题库名称" placeholder="输入题库名称" clearable class="pa-0" full-width></v-text-field>
                        </v-col>
                    </v-row>
                </v-col>
                <v-col cols="12" sm="9">
                    <v-row class="pl-12">
                        ...
                        <v-col cols="12" class="filter-section pa-0">
                            <div class="filter-group">
                                ...
                                <v-chip v-for="subject in subjects" :key="subject" class="ma-2" color="primary" variant="outlined" :class="{ 'selected-chip': selectedSubject === subject }" @click="toggleSubject(subject)">
                                    {{ subject }}
